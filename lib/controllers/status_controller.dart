...
class StatusController  extends  ChangeNotifier {
  ...
  Future<void> checkIn(BuildContext context) async {
    ...
    // POST 요청을 보낼 URL
    final url = 'http://192.168.25.31:8863/api/users/checkIn';
  ...
  Future<void> checkOut(BuildContext context) async {
    ...
    // PUT 요청을 보낼 URL
    final url = 'http://192.168.25.31:8863/api/users/checkOut';
  ...
  Future<void> getAttendanceInfo() async {
    ...
    final url = 'http://192.168.25.31:8863/api/users/attendanceInfo';
    final headers = {
      'Content-Type': 'application/json',
      if (token != null) 'Authorization': 'Bearer $token',
    };
